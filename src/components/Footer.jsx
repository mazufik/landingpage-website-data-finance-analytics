...
const Footer = () => {
  return (
    <div className='max-w-[1240px] py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
      <div>
        <h1 className='w-full text-3xl font-bold text-[#02a9f7]'>React.</h1>
        <p className='py-4'>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Deleniti ea
          consectetur eaque eos nam, amet molestias possimus dolorum sequi,
          atque quam a maiores quae ad?
        </p>
